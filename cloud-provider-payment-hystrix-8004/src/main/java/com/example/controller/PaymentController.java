...
public class PaymentController {
    ...
    @GetMapping("/payment/hystrix/circuitbreak/{id}")
    public CommonResult<?> paymentCircuitBreak(@PathVariable("id") Long id) {
        return new CommonResult<>(200, "success", paymentService.paymentCircuitBreaker(id));
    }
}
